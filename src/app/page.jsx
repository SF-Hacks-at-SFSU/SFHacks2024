...
export default function Home() {
  return (
    <main className="bg-[#254d70]">
      <section className="h-auto items-center bg-sfDarkBlue flex flex-row gap-[10%] justify-center object-cover bg-[url('/brand-assets/background-bridge.png')] bg-cover p-[5%]">
        <img
          className="h-[70vh] hidden lg:block"
          src="/brand-assets/purple-logo.png"
        />
        <div className="w-[600px] gap-2.5 flex flex-col items-center text-[rgba(245,245,245,0.65)] text-base not-italic font-[550] leading-[normal] text-center m-5">
          ...
          <h1 className="pt-5 text-[#ebebeb] text-[1.5rem]">
