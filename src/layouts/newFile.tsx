<Fragment>
{/** This is a stolen navbar, make sure we change this */}<html>
<head>
</head>
<body>


<nav style="width: 1472px; height: 147px; background: #838FBA"> {/**this is the background of the whole navbar */}
<div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
<a href="/" class="flex items-center">
<img src="/Mascot.png" style="width: 101px; height: 96px;" alt="Cyber Gator" />
{/** <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">SF Hacks 2023</span> */}
</a>
...
<path stroke="currentColor" d="M1 1h15M1 7h15M1 13h15" {...{ "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2" }} />
</svg>
</button>
...
<li>
<a href="#" class="nav-button">Sponsors</a>
</li>
<li>
